...
permutations = 100000
h_dich = pd.read_csv("s2_periphery/dichotomised_genes.csv",index_col="gene_id")
t_dich = pd.read_csv("s2_tumour/dichotomised_genes.csv",index_col="gene_id")
# familyset of both the tumour/periphery is identical
familyset = pd.read_csv("s2_periphery/familyset.csv",
...
if __name__ == "__main__":
    ...
    pd.concat([p_df,family_name],axis=1).to_csv("ic_fc_s2.csv")
